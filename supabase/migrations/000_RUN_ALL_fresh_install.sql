...
-- ============================================
-- Files 001 through 007 concatenated in order, for a database that
-- doesn't have any of this yet. None of these are wrapped in a single
-- all-or-nothing transaction — every statement commits on its own, so if
-- something fails partway through, everything before it is already
-- saved. Fix the failing statement and continue from there.
...
-- ============================================
-- FROM: 006_reject_and_monthly_reports.sql
-- ============================================
-- ============================================
...
-- ============================================
-- FROM: 007_news_testimonials_notifications.sql
-- ============================================
-- ============================================
